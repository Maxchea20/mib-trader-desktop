...
CONFIG = {
    ...
    # New trades are opened ONLY by the scenario engine
    # (scenario_live_bridge.py). Fixed, not configurable -- the legacy
    # Hunt C-FI FIRE path was removed. Reported so the UI can label it.
    "entry_engine": "scenario",
    # Which M5 slots are allowed to actually open a live entry. Slots
    # are the three 5-minute candles right AFTER the M15 breakout candle
    # closes. Every slot in this list is routed
