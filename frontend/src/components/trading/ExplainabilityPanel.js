...
export const ExplainabilityPanel = ({ brain }) => {
  ...
  return (
    <div className="breathe-glow panel p-4 fade-up" style={cardGlow(brain.state)} data-testid="explainability-panel">
        ...
        {(brain.reasons || []).map((r, i) => (
          <div key={i} className="flex gap-2 items-start">
            <span
              ...
              style={{
                background: st.raw === "none" ? "#94a3b8" : st.raw,
                boxShadow: st.glow === "none" ? "none" : `0 0 6px ${st.raw}`,
              }}
            />
